...
# MongoDB connection using dependency injection (like saved_events)
# Remove the global connection - we'll use dependency injection
...
async def create_advice_direct(
    ...
    return await create_advice_impl(advice_data, current_user, db)
